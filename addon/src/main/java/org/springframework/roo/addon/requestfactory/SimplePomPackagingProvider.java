...
@Component
@Service
public class SimplePomPackagingProvider extends AbstractPackagingProvider {

    /**
     * Constructor invoked by the OSGi container
     */
    public SimplePomPackagingProvider() {
        super("pom_simple", "pom", "simple-pom-template.xml");
    }
