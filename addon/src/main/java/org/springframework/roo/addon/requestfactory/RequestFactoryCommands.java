...
public class RequestFactoryCommands implements CommandMarker {
    ...
    @CliAvailabilityIndicator({ WEB_REQUEST_FACTORY_SETUP_ADDON_COMMAND })
    public boolean isRequestFactoryAddonSetupAvailable() {
        return requestFactoryOperations.isRequestFactoryAddonInstallationPossible();
    }
    ...
    @CliCommand(value = WEB_REQUEST_FACTORY_SETUP_ADDON_COMMAND, help = "Install RequestFactory add-on into your project")
    public void webRequestFactoryAddonSetup() {
        requestFactoryOperations.setupRequestFactoryAddon();
    }
    ...
    public void proxyAll(
            @CliOption(key = PACKAGE_KEY, mandatory = false, optionContext = JavaTypeConverter.PROJECT, unspecifiedDefaultValue = PROXY_PACKAGE_DEFAULT, help = "The package in which created proxies will be placed") final JavaPackage javaPackage,
    ...
    public void requestAll(
            @CliOption(key = PACKAGE_KEY, mandatory = false, optionContext = JavaTypeConverter.PROJECT, unspecifiedDefaultValue = REQUEST_PACKAGE_DEFAULT, help = "The package in which created requests will be placed") final JavaPackage javaPackage) {
    ...
    public void proxyAndRequestAll(
            @CliOption(key = PROXY_PACKAGE_KEY, mandatory = false, optionContext = JavaTypeConverter.PROJECT, unspecifiedDefaultValue = PROXY_PACKAGE_DEFAULT, help = "The package in which created proxies will be placed") final JavaPackage proxyPackage,
            @CliOption(key = REQUEST_PACKAGE_KEY, mandatory = false, optionContext = JavaTypeConverter.PROJECT, unspecifiedDefaultValue = REQUEST_PACKAGE_DEFAULT, help = "The package in which created requests will be placed") final JavaPackage requestPackage,
