...
import static org.springframework.roo.addon.gwt.RequestFactoryJavaType.ENTITY_PROXY;
import static org.springframework.roo.addon.gwt.RequestFactoryJavaType.OLD_ENTITY_PROXY;
...
import org.springframework.roo.addon.gwt.RequestFactoryFileManager;
import org.springframework.roo.addon.gwt.RequestFactoryTypeService;
import org.springframework.roo.addon.gwt.RequestFactoryUtils;
...
@Service
public class RequestFactoryProxyMetadataProviderImpl extends
        AbstractHashCodeTrackingMetadataNotifier implements
        RequestFactoryProxyMetadataProvider {
    ...
    public MetadataItem get(final String metadataIdentificationString) {
        ...
        final JavaType mirroredType = RequestFactoryUtils.lookupProxyTargetType(proxy);
...
//            }
    ...
    private ClassOrInterfaceTypeDetails getGovernor(
        ...
        final JavaType governorTypeName = RequestFactoryProxyMetadata
                .getJavaType(metadataIdentificationString);
        final LogicalPath governorTypePath = RequestFactoryProxyMetadata
    ...
    public String getProvidesType() {
        return RequestFactoryProxyMetadata.getMetadataIdentifierType();
    }
    ...
    public void notify(final String upstreamDependency,
        ...
        if (MetadataIdentificationUtils
            ...
            if (MemberFindingUtils.getAnnotationOfType(cid.getAnnotations(),
                        ...
                        if (attributeValue != null) {
                            ...
                            if (mirrorName != null
                                ...
                                final LogicalPath typePath = PhysicalTypeIdentifier
                                        .getPath(proxyCid
                                                .getDeclaredByMetadataId());
                                downstreamDependency = RequestFactoryProxyMetadata
                ...
                downstreamDependency = RequestFactoryProxyMetadata.createIdentifier(
                        typeName, typePath);
            }
    ...
    private String updateProxy(final ClassOrInterfaceTypeDetails proxy,
        ...
        return requestFactoryFileManager.write(cidBuilder.build(),
