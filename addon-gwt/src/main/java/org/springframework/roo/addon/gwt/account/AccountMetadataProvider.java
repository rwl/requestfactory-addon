...
@Component
@Service
public final class AccountMetadataProvider extends AbstractItdMetadataProvider {
    ...
    protected void activate(ComponentContext context) {
        ...
        addMetadataTrigger(new JavaType(RooAccount.class.getName()));
    }
    ...
    protected ItdTypeDetailsProvidingMetadataItem getMetadata(String metadataIdentificationString, JavaType aspectName, PhysicalTypeMetadata governorPhysicalTypeMetadata, String itdFilename) {
        ...
        return new AccountMetadata(metadataIdentificationString, aspectName, governorPhysicalTypeMetadata);
    }
