...
@Service
public class RequestFactoryRequestMetadataNotificationListener implements
            ...
            if (gwtRequestAnnotation != null) {
                ...
                Validate.validState(attributeValue != null,
                        "The x annotation should have a '" + "value"
                                + "' attribute");
                final String entityClass = RequestFactoryUtils
    ...
    private String getLocalMid(final String physicalTypeId) {
        ...
        return RequestFactoryRequestMetadata.createIdentifier(typeName, typePath);
    }
    ...
    public void notify(final String upstreamMID, final String downstreamMID) {
        ...
        Validate.isTrue(PhysicalTypeIdentifierNamingUtils.isValid(
                RequestFactoryRequestMetadata.class.getName(), downstreamInstanceId));
