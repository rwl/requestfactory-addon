...
public class RequestFactoryProxyProperty {
    ...
    public static String getProxyRendererType(
        ...
        return RequestFactoryType.EDIT_RENDERER.getPath().packageName(topLevelPackage)
    ...
    private String getSetEditor() {
        ...
        return typeName
                + (type.getSimpleTypeName().equals("Set") ? RequestFactoryType.SET_EDITOR
                        .getSuffix() : RequestFactoryType.LIST_EDITOR.getSuffix());
    }

    public JavaType getSetEditorType() {
        return new JavaType(RequestFactoryType.SET_EDITOR.getPath().packageName(
                topLevelPackage)
                + "." + getSetEditor());
    }
