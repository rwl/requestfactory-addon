...
import static org.springframework.roo.addon.requestfactory.GwtJavaType.ACCEPTS_ONE_WIDGET;
import static org.springframework.roo.addon.requestfactory.GwtJavaType.ENTITY_PROXY;
import static org.springframework.roo.addon.requestfactory.GwtJavaType.EVENT_BUS;
import static org.springframework.roo.addon.requestfactory.GwtJavaType.PLACE;
import static org.springframework.roo.addon.requestfactory.GwtJavaType.RECEIVER;
...
public enum GwtType {
    ...
    DATA_PROVIDER(GwtPath.MANAGED_TREE, true, "DataProvider", "dataProvider", "DataProvider", false, false, false),
    IS_LEAF_PROCESSOR(GwtPath.MANAGED_TREE, false, "", "isLeafProcessor", "IsLeafProcessor", false, false, false),
    PROXY_LIST_NODE_PROCESSOR(GwtPath.MANAGED_TREE, false, "", "proxyListNodeProcessor", "ProxyListNodeProcessor", false, false, false),
    PROXY_NODE_PROCESSOR(GwtPath.MANAGED_TREE, false, "", "proxyNodeProcessor", "ProxyNodeProcessor", false, false, false),
