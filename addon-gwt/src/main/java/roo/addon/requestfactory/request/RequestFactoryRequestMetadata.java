package roo.addon.requestfactory.request;
...
public class RequestFactoryRequestMetadata extends AbstractMetadataItem {

    private static final String PROVIDES_TYPE_STRING = RequestFactoryRequestMetadata.class
            .getName();
     ...
     */
    public RequestFactoryRequestMetadata(final String id, final String requestTypeContents) {
        super(id);
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof RequestFactoryRequestMetadata)) {
            return false;
        }
        final RequestFactoryRequestMetadata other = (RequestFactoryRequestMetadata) obj;
